...
export default function NewsCategoriesScreen(props) {
  ...
  const temp = [];
  function addfavourites(item, index, arr) {
    temp.push(arr[index].name);
  }

  props.route.params.item.favCategories.forEach(addfavourites);

  function changeState(item, index, arr) {
    switch (arr[index]) {
      case "Politics":
        initialState.politics = true;
        break;

      case "Entertainment":
        initialState.entertainment = true;
        break;

      case "World":
        initialState.world = true;
        break;

      case "Technology":
        initialState.technology = true;
        break;

      case "Sports":
        initialState.sports = true;
        break;

      case "Business":
        initialState.business = true;
        break;

      case "Health":
        initialState.health = true;
        break;

      case "Religion":
        initialState.religion = true;
        break;

      case "Travel":
        initialState.travel = true;
        break;

      case "Fashion":
        initialState.fashion = true;
        break;
    }
  }

  temp.forEach(changeState);
