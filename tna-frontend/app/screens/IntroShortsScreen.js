...
export default function IntroShortsScreen() {
    return (
        <SafeAreaView style= {styles.container}>
            <Image style= {styles.shortsImage} source={require("../assets/shorts.jpg")}/>
            <View style= {styles.shortsDescription}> 
                <Text style= {styles.shortsTitle}>Short {'&'} Simple</Text>
                <Text numberOfLines={2} style= {styles.shortsSubtitle}>Save your time with our short and simple news</Text>
            </View>
