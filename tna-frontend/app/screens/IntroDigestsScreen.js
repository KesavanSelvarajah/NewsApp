...
export default function IntroDigestsScreen() {
    return (
        <SafeAreaView style= {styles.container}>
            <Image style= {styles.digestsImage} source={require("../assets/digests.jpg")}/>
            <View style= {styles.digestsDescription}> 
                <Text style= {styles.digestsTitle}>Daily Digests</Text>
                <Text numberOfLines={2} style= {styles.digestsSubtitle}>Know what happened today in a one single page</Text>
            </View>
